...
def GetElectricSystemModel_Belfort_SingleNode(areaConsumption,lossesRate,availabilityFactor,
    ...
    '''
    First version of Belfort model. Now deprecated because hydrogen
    for final use is not merged with hydrogen for grid use.

    :param areaConsumption:
    :param lossesRate:
    :param availabilityFactor:
    :param TechParameters:
    :param StorageParameters:
    :param to_flex_consumption:
    :param FlexParameters:
    :param labour_ratio:
    :param TimeName:
    :param TechName:
    :param StockTechName:
    :param FlexName:
    :param FlexConsumptionName:
    :param areaConsumptionName:
    :param availabilityFactorName:
    :param LaborRatioName:
    :param lossesRateName:
    :return: model.
    '''
    ## Generic variables
...
def GetElectricSystemModel_Belfort_SingleNode_H2(areaConsumption,lossesRate,availabilityFactor,
    ...
    '''
    New single node function. To be used for quick computations
    but does not take into account connections with foreign
    countries (France is simulated alone).
    ...
    :param FlexParameters:
    :param labour_ratio:
    :param H2_consumption:
    :param TimeName:
    :param TechName:
    :param StockTechName:
    :param FlexName:
    :param PowertoH2toPowerName:
    :param FlexConsumptionName:
    :param areaConsumptionName:
    :param availabilityFactorName:
    :param LaborRatioName:
    :param lossesRateName:
    :param H2ConsumptionName:
    :return: model.
    '''
    ## Generic variables
    d1h = timedelta(hours=1)
...
def GetElectricSystemModel_Belfort_MultiNode(areaConsumption, lossesRate, availabilityFactor,
    ...
    '''
    Multinode function. To use for complete simulation with 7 countries :

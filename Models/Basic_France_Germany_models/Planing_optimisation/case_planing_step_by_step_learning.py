...
from Models.Basic_France_Germany_models.Planing_optimisation.f_planingModels import *
#endregion
...
InputPlaningFolder='Models/Basic_France_Germany_models/Planing_optimisation/Data/'
GraphicalResultsFolder="Models/Basic_France_Germany_models/Planing_optimisation/GraphicalResults/"
...
TechParameters = pd.read_csv(InputPlaningFolder+'Planing_MultiNode_DE-FR_TECHNOLOGIES_AREAS.csv',
...
StorageParameters = pd.read_csv(InputPlaningFolder+'Planing_MultiNode_AREAS_DE-FR_STOCK_TECHNO.csv',sep=',',decimal='.',comment="#",skiprows=0).set_index(["AREAS","STOCK_TECHNO"])

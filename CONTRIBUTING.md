# Contributing to Energy-Alternative-Planning
We want to make contributing to this project as easy and transparent as possible, whether it's:

- Reporting a bug
- Discussing the current state of the code
- Discussing modelling
- Providing validation test cases
- Submitting a fix
...
We use Gitlab issues to track public bugs. Report a bug by opening an issue, it's that easy!
